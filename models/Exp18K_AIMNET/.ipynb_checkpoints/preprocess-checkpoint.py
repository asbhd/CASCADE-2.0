...
shifts = pd.read_pickle('../../data/Exp18K_AIMNET/NMR18K_AIMNET_Shifts.pkl')

mols = []
with gzip.open('../../data/Exp18K_AIMNET/NMR18K_AIMNET.sdf.gz', 'r') as sdfile:
...
test = df_Shift.sample(n=1800, random_state=666)
valid = df_Shift[~df_Shift.index.isin(test.index)].sample(n=1800, random_state=666)
train = df_Shift[
